...
(function($) {
	...
	$.message.defaults = {
		...
		minDuration: 2500,
		totalTimeout: 6000,
		template: '<div class="jquery-message"> <p></p> </div></div>',
        error_template: '<div class="jquery-error-message"> <p></p> </div></div>'//'<div class="jquery-error-message"><div class="round"></div><p></p><div class="round"></div></div>'
	}
})(jQuery);
